                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Click Tracker</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Track individual and unique clicks
                                </p>
                            </div>
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Manage Links</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Create, Read, Update, Delete shortlinks.  Manage shortlinks on dashboard. Add custom parameters to redirects.
                                </p>
                            </div>
                        ...
                        <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Analytics</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Click tracking. IP address, device, browser, country,refferer, user agent detection.
                                </p>
                            </div>
                        </div>
                    </div>
