    ...
    <div>{{ sortedMetadatas }}
        ...
        <v-form
            ...
            <v-card
                ...
                <v-card-actions
                    :class="state.shortlink.is_active
                        ? 'd-flex flex-wrap bg-indigo-darken-2'
                        : 'd-flex flex-wrap bg-black'">
                ...
                <v-card-actions
                    :class="state.shortlink.is_active
                        ? 'd-flex flex-wrap justify-end bg-indigo-darken-3'
                        : 'd-flex justify-end flex-wrap bg-black'">
